...
import static apps.IrvinTheSenpai.MiStore.Constants.DB_NAME;
import static apps.IrvinTheSenpai.MiStore.Constants.TABLE_NAME;
...
public class MyDbHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ModelRecord> searchRecords(String query){
        ...
        ArrayList<ModelRecord> recordsList = new ArrayList<>();
        // consulta para seleccionar registros
        String selectQuery = " SELECT * FROM " + TABLE_NAME + " WHERE " + Constants.C_NAME + " LIKE '%" + query +"%'";
